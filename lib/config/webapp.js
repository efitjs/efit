...
module.exports = function (config) {
  ...
  // 匹配所有less文件
  fis.match('*.less', {
    parser: fis.plugin('less-2.x') // fis3-parser-less-2.x
  });
  ...
  fis.match('*.{js,jsx,es,ts,tsx}', {
    ...
    useHash: true,
    preprocessor: [
      fis.plugin('js-require-css'), // fis3-preprocessor-js-require-css
      fis.plugin('js-require-file') // fis3-preprocessor-js-require-file
    ]
  });
  
  // TODO:匹配所有typescript文件
  fis.match('*.{ts,tsx}', {
  ...
  fis.match('/node_modules/(**)(.js)', {
    ...
    isMod: true,
    useSameNameRequire: true,
    parser: null, // 生态的js不做编译
    preprocessor: null// 生态的js不做文件处理
  });
